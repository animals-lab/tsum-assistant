...
class Customer(SQLModel, table=True):
    ...
    def prompt(self) -> str:
        ...
        if self.liked_brand_names:
            parts.append(f"Liked brands, you should add them to very generic queries, but don't use when user asks for any specific details : {'; '.join(self.liked_brand_names)}")
